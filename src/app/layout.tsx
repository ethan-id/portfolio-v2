...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description:
            'Explore the software engineering portfolio of Ethan Hancock. Specializing in avaScript, TypeScript, Java, Python, and more, Ethan has a diverse range of skills and experiences.',
        url: 'https://www.ethanhancock.org',
        type: 'website',
        siteName: 'Ethan Hancock - Software Engineer',
        images: [
            {
                url: 'https://www.ethanhancock.org/me.png',
                width: 1171,
                height: 1171,
                alt: 'Ethan Hancock'
            }
